...
wp_register_script( 'searchBox', get_bloginfo('template_directory').'/js/searchBox.js', FALSE, FALSE, TRUE);
...
<div id="index">
	...
	?><div class="hidden" id="noRecord">No results</div>
